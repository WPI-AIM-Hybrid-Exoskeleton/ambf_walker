...
def raise_leg_traj(pos, tf=2, dt=0.01):
    hip = utlities.get_traj( pos[0], -0.75, 0.0, 0.0, tf, dt)
    knee = utlities.get_traj(pos[1], 0.75, 0.0, 0., tf, dt)
    ankle = utlities.get_traj(pos[2], -0.30,  0.0, 0.0, tf, dt)
    return hip, knee, ankle
