...
"""autogenerated by genpy from ambf_walker/DesiredJoints.msg. Do not edit."""
import sys
...
class DesiredJoints(genpy.Message):
  _md5sum = "6ec277a08c216dac90cc1e9402138069"
  _type = "ambf_walker/DesiredJoints"
...
string frame_id
"""
  __slots__ = ['header','q','qd','qdd','controllers']
  _slot_types = ['std_msgs/Header','float64[]','float64[]','float64[]','string[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DesiredJoints, self).__init__(*args, **kwds)
