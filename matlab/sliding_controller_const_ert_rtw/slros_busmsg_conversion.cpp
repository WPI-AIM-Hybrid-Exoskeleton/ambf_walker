...
// Conversions between SL_Bus_sliding_controller_const_ambf_walker_DesiredJoints and ambf_walker::DesiredJoints
...
// Conversions between SL_Bus_sliding_controller_const_RBDLInverseDynamicsReques_9pm1f and rbdl_server::RBDLInverseDynamicsRequest
...
// Conversions between SL_Bus_sliding_controller_const_RBDLInverseDynamicsRespon_g20gt and rbdl_server::RBDLInverseDynamicsResponse
...
// Conversions between SL_Bus_sliding_controller_const_ros_time_Time and ros::Time
...
// Conversions between SL_Bus_sliding_controller_const_sensor_msgs_JointState and sensor_msgs::JointState
...
// Conversions between SL_Bus_sliding_controller_const_std_msgs_Bool and std_msgs::Bool
...
// Conversions between SL_Bus_sliding_controller_const_std_msgs_Float64 and std_msgs::Float64

void convertFromBus(std_msgs::Float64* msgPtr, SL_Bus_sliding_controller_const_std_msgs_Float64 const* busPtr)
{
...
void convertToBus(SL_Bus_sliding_controller_const_std_msgs_Float64* busPtr, std_msgs::Float64 const* msgPtr)
{
  const std::string rosMessageType("std_msgs/Float64");
...
// Conversions between SL_Bus_sliding_controller_const_std_msgs_Header and std_msgs::Header
...
// Conversions between SL_Bus_sliding_controller_const_std_srvs_SetBoolRequest and std_srvs::SetBoolRequest
...
// Conversions between SL_Bus_sliding_controller_const_std_srvs_SetBoolResponse and std_srvs::SetBoolResponse
