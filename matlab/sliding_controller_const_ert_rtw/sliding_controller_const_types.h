...
//
// File: sliding_controller_const_types.h
//
...
//
#ifndef RTW_HEADER_sliding_controller_const_types_h_
#define RTW_HEADER_sliding_controller_const_types_h_
#include "rtwtypes.h"

// Model Code Variants
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_std_msgs_Float64_
#define DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_std_msgs_Float64_

// MsgType=std_msgs/Float64
struct SL_Bus_sliding_controller_const_std_msgs_Float64
{
  real_T Data;
};
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_ros_time_Time_
#define DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_ros_time_Time_

// MsgType=ros_time/Time
struct SL_Bus_sliding_controller_const_ros_time_Time
{
  real_T Sec;
  real_T Nsec;
};
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_std_msgs_Header_
#define DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_std_msgs_Header_

// MsgType=std_msgs/Header
struct SL_Bus_sliding_controller_const_std_msgs_Header
{
  uint32_T Seq;

  // MsgType=ros_time/Time
  SL_Bus_sliding_controller_const_ros_time_Time Stamp;
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_std_msgs_String_
#define DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_std_msgs_String_

// MsgType=std_msgs/String
struct SL_Bus_sliding_controller_const_std_msgs_String
{
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_sensor_msgs_JointState_
#define DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_sensor_msgs_JointState_

// MsgType=sensor_msgs/JointState
struct SL_Bus_sliding_controller_const_sensor_msgs_JointState
{
  // MsgType=std_msgs/Header
  SL_Bus_sliding_controller_const_std_msgs_Header Header;
  ...
  SL_Bus_sliding_controller_const_std_msgs_String Name[16];
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_RBDLInverseDynamicsReques_9pm1f_
#define DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_RBDLInverseDynamicsReques_9pm1f_

// MsgType=rbdl_server/RBDLInverseDynamicsRequest
struct SL_Bus_sliding_controller_const_RBDLInverseDynamicsReques_9pm1f
{
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_std_msgs_Bool_
#define DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_std_msgs_Bool_

// MsgType=std_msgs/Bool
struct SL_Bus_sliding_controller_const_std_msgs_Bool
{
  boolean_T Data;
};
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_RBDLInverseDynamicsRespon_g20gt_
#define DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_RBDLInverseDynamicsRespon_g20gt_

// MsgType=rbdl_server/RBDLInverseDynamicsResponse
struct SL_Bus_sliding_controller_const_RBDLInverseDynamicsRespon_g20gt
{
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_ambf_walker_DesiredJoints_
#define DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_ambf_walker_DesiredJoints_

// MsgType=ambf_walker/DesiredJoints
struct SL_Bus_sliding_controller_const_ambf_walker_DesiredJoints
{
  // MsgType=std_msgs/Header
  SL_Bus_sliding_controller_const_std_msgs_Header Header;
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_std_srvs_SetBoolRequest_
#define DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_std_srvs_SetBoolRequest_

// MsgType=std_srvs/SetBoolRequest
struct SL_Bus_sliding_controller_const_std_srvs_SetBoolRequest
{
  boolean_T Data;
};
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_std_srvs_SetBoolResponse_
#define DEFINED_TYPEDEF_FOR_SL_Bus_sliding_controller_const_std_srvs_SetBoolResponse_

// MsgType=std_srvs/SetBoolResponse
struct SL_Bus_sliding_controller_const_std_srvs_SetBoolResponse
{
  boolean_T Success;
...
#ifndef struct_ros_slroscpp_internal_block_f_T
#define struct_ros_slroscpp_internal_block_f_T

struct ros_slroscpp_internal_block_f_T
{
  boolean_T matlabCodegenIsDeleted;
  int32_T isInitialized;
  boolean_T isSetupComplete;
...
#endif                                // struct_ros_slroscpp_internal_block_f_T
...
#endif                          // RTW_HEADER_sliding_controller_const_types_h_
