...
//
// File: sliding_controller_const_data.cpp
//
...
sliding_controller_constModelClass::P_sliding_controller_const_T
  sliding_controller_constModelClass::sliding_controller_const_P = {
  // Variable: alpha
  ...
  // Expression: [-0.5 0.5 -0.28 -0.5 0.5 -0.28 0]
