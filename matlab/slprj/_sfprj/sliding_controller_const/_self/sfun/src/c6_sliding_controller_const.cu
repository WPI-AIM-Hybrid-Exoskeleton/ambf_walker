...
static void initialize_c6_sliding_controller_const
  (SFc6_sliding_controller_constInstanceStruct *chartInstance);
static void initialize_params_c6_sliding_controller_const
  (SFc6_sliding_controller_constInstanceStruct *chartInstance);
static void enable_c6_sliding_controller_const
  (SFc6_sliding_controller_constInstanceStruct *chartInstance);
static void disable_c6_sliding_controller_const
  (SFc6_sliding_controller_constInstanceStruct *chartInstance);
static void c6_do_animation_call_c6_sliding_controller_const
  (SFc6_sliding_controller_constInstanceStruct *chartInstance);
static void ext_mode_exec_c6_sliding_controller_const
  (SFc6_sliding_controller_constInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_sliding_controller_const
  (SFc6_sliding_controller_constInstanceStruct *chartInstance);
static void set_sim_state_c6_sliding_controller_const
  (SFc6_sliding_controller_constInstanceStruct *chartInstance, const mxArray
   *c6_st);
static void sf_gateway_c6_sliding_controller_const
  (SFc6_sliding_controller_constInstanceStruct *chartInstance);
static void mdl_start_c6_sliding_controller_const
  (SFc6_sliding_controller_constInstanceStruct *chartInstance);
static void mdl_terminate_c6_sliding_controller_const
  (SFc6_sliding_controller_constInstanceStruct *chartInstance);
static void mdl_setup_runtime_resources_c6_sliding_controller_const
  (SFc6_sliding_controller_constInstanceStruct *chartInstance);
static void mdl_cleanup_runtime_resources_c6_sliding_controller_const
  (SFc6_sliding_controller_constInstanceStruct *chartInstance);
static void initSimStructsc6_sliding_controller_const
  (SFc6_sliding_controller_constInstanceStruct *chartInstance);
static void c6_emlrt_marshallIn(SFc6_sliding_controller_constInstanceStruct
  *chartInstance, const mxArray *c6_b_msg, const char_T *c6_identifier,
  c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_y);
static void c6_b_emlrt_marshallIn(SFc6_sliding_controller_constInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_y);
static void c6_c_emlrt_marshallIn(SFc6_sliding_controller_constInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  c6_SL_Bus_sliding_controller_const_std_msgs_Header *c6_y);
static uint32_T c6_d_emlrt_marshallIn
  (SFc6_sliding_controller_constInstanceStruct *chartInstance, const mxArray
   *c6_u, const emlrtMsgIdentifier *c6_parentId);
static c6_SL_Bus_sliding_controller_const_ros_time_Time c6_e_emlrt_marshallIn
  (SFc6_sliding_controller_constInstanceStruct *chartInstance, const mxArray
   *c6_u, const emlrtMsgIdentifier *c6_parentId);
static real_T c6_f_emlrt_marshallIn(SFc6_sliding_controller_constInstanceStruct *
  chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_g_emlrt_marshallIn(SFc6_sliding_controller_constInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  uint8_T c6_y[128]);
static c6_SL_Bus_ROSVariableLengthArrayInfo c6_h_emlrt_marshallIn
  (SFc6_sliding_controller_constInstanceStruct *chartInstance, const mxArray
   *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_i_emlrt_marshallIn(SFc6_sliding_controller_constInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  c6_SL_Bus_sliding_controller_const_std_msgs_String c6_y[16]);
static void c6_j_emlrt_marshallIn(SFc6_sliding_controller_constInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  real_T c6_y[7]);
static uint8_T c6_k_emlrt_marshallIn(SFc6_sliding_controller_constInstanceStruct
  *chartInstance, const mxArray *c6_b_is_active_c6_sliding_controller_const,
  const char_T *c6_identifier);
static uint8_T c6_l_emlrt_marshallIn(SFc6_sliding_controller_constInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_eML_blk_kernel(SFc6_sliding_controller_constInstanceStruct
  *chartInstance, c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState
  *c6_b_blankMsg);
static __global__ void c6_sf_gateway_c6_sliding_controller_const_kernel1
  (c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_blankMsg,
   c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_msg);
static __global__ void c6_sf_gateway_c6_sliding_controller_const_kernel2(const
  int32_T c6_i1, c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState
  *c6_b_blankMsg, c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState
  *c6_b_msg);
static __global__ void c6_sf_gateway_c6_sliding_controller_const_kernel3
  (c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_blankMsg,
   c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_msg);
static __global__ void c6_sf_gateway_c6_sliding_controller_const_kernel4
  (c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_msg,
   c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_r);
static __global__ void c6_sf_gateway_c6_sliding_controller_const_kernel5(const
  int32_T c6_i5, c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState
  *c6_b_msg, c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_r);
static __global__ void c6_sf_gateway_c6_sliding_controller_const_kernel6
  (c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_msg,
   c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_r);
static __global__ void c6_sf_gateway_c6_sliding_controller_const_kernel7(const
  c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_r,
  c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_msg);
static __global__ void c6_sf_gateway_c6_sliding_controller_const_kernel8(const
  c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_r, const int32_T
  c6_i9, c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_msg);
static __global__ void c6_sf_gateway_c6_sliding_controller_const_kernel9(const
  c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_r,
  c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_msg);
...
static __global__ void c6_eML_blk_kernel_kernel24
  (c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_blankMsg);
static void init_dsm_address_info(SFc6_sliding_controller_constInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc6_sliding_controller_constInstanceStruct
  *chartInstance);
  ...
  (SFc6_sliding_controller_constInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_sliding_controller_const = 0U;
  cudaGetLastError();
  ...
  (SFc6_sliding_controller_constInstanceStruct *chartInstance)
{
  ...
  c6_SL_Bus_sliding_controller_const_std_msgs_String c6_g_u[16];
  const c6_SL_Bus_sliding_controller_const_std_msgs_String *c6_r;
  ...
  c6_u_Seq = *(uint32_T *)&((char_T *)
    (c6_SL_Bus_sliding_controller_const_std_msgs_Header *)&((char_T *)
    chartInstance->c6_msg)[0])[0];
  c6_u_Stamp_Sec = *(real_T *)&((char_T *)
    (c6_SL_Bus_sliding_controller_const_ros_time_Time *)&((char_T *)
    (c6_SL_Bus_sliding_controller_const_std_msgs_Header *)&((char_T *)
  ...
  for (c6_i2 = 0; c6_i2 < 16; c6_i2++) {
    for (c6_i3 = 0; c6_i3 < 128; c6_i3++) {
      c6_g_u[c6_i2].Data[c6_i3] = ((uint8_T *)&((char_T *)
        (c6_SL_Bus_sliding_controller_const_std_msgs_String *)&((char_T *)
        (c6_SL_Bus_sliding_controller_const_std_msgs_String *)&((char_T *)
  ...
  sf_mex_assign(&c6_gb_y, sf_mex_create("y",
    &chartInstance->c6_is_active_c6_sliding_controller_const, 3, 0U, 0U, 0U, 0),
                false);
   ...
   *c6_st)
{
  ...
  c6_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 0)), "msg",
                      &c6_r);
  *(uint32_T *)&((char_T *)(c6_SL_Bus_sliding_controller_const_std_msgs_Header *)
                 &((char_T *)chartInstance->c6_msg)[0])[0] = c6_r.Header.Seq;
  *(real_T *)&((char_T *)(c6_SL_Bus_sliding_controller_const_ros_time_Time *)
               &((char_T *)(c6_SL_Bus_sliding_controller_const_std_msgs_Header *)
  ...
  *(real_T *)&((char_T *)(c6_SL_Bus_sliding_controller_const_ros_time_Time *)
  ...
  for (c6_i = 0; c6_i < 128; c6_i++) {
    ((uint8_T *)&((char_T *)(c6_SL_Bus_sliding_controller_const_std_msgs_Header *)
  ...
  *(uint32_T *)&((char_T *)(c6_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
  ...
  for (c6_i1 = 0; c6_i1 < 16; c6_i1++) {
    for (c6_i2 = 0; c6_i2 < 128; c6_i2++) {
      ((uint8_T *)&((char_T *)
                    (c6_SL_Bus_sliding_controller_const_std_msgs_String *)
                    &((char_T *)
                      (c6_SL_Bus_sliding_controller_const_std_msgs_String *)
  ...
  *(uint32_T *)&((char_T *)(c6_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
  ...
  chartInstance->c6_is_active_c6_sliding_controller_const =
    c6_k_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 1)),
    "is_active_c6_sliding_controller_const");
  sf_mex_destroy(&c6_u);
...
{
  c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState c6_r;
  c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_gpu_blankMsg;
  c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_gpu_msg;
  c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_gpu_r;
  int32_T c6_i1;
  int32_T c6_i5;
  int32_T c6_i9;
  ...
  *(uint32_T *)&((char_T *)(c6_SL_Bus_sliding_controller_const_std_msgs_Header *)
    ...
    &((char_T *)(c6_SL_Bus_sliding_controller_const_std_msgs_Header *)&((char_T *)
       chartInstance->c6_blankMsg)[0])[0];
  *(real_T *)&((char_T *)(c6_SL_Bus_sliding_controller_const_ros_time_Time *)
               &((char_T *)(c6_SL_Bus_sliding_controller_const_std_msgs_Header *)
                 &((char_T *)chartInstance->c6_msg)[0])[8])[0] = *(real_T *)
    &((char_T *)(c6_SL_Bus_sliding_controller_const_ros_time_Time *)&((char_T *)
       (c6_SL_Bus_sliding_controller_const_std_msgs_Header *)&((char_T *)
  ...
  *(real_T *)&((char_T *)(c6_SL_Bus_sliding_controller_const_ros_time_Time *)
  ...
  c6_sf_gateway_c6_sliding_controller_const_kernel1<<<dim3(1U, 1U, 1U), dim3
    (128U, 1U, 1U)>>>(c6_b_gpu_blankMsg, c6_gpu_msg);
  ...
  *(uint32_T *)&((char_T *)(c6_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
  ...
  for (c6_i1 = 0; c6_i1 < 16; c6_i1++) {
    cudaMemcpy(c6_b_gpu_blankMsg, chartInstance->c6_blankMsg, 2536UL,
               cudaMemcpyHostToDevice);
    cudaMemcpy(c6_gpu_msg, chartInstance->c6_msg, 2536UL, cudaMemcpyHostToDevice);
    c6_sf_gateway_c6_sliding_controller_const_kernel2<<<dim3(1U, 1U, 1U), dim3
      (128U, 1U, 1U)>>>(c6_i1, c6_b_gpu_blankMsg, c6_gpu_msg);
    cudaMemcpy(chartInstance->c6_msg, c6_gpu_msg, 2536UL, cudaMemcpyDeviceToHost);
    cudaMemcpy(chartInstance->c6_blankMsg, c6_b_gpu_blankMsg, 2536UL,
               cudaMemcpyDeviceToHost);
    *(uint32_T *)&((char_T *)(c6_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
  ...
  *(uint32_T *)&((char_T *)(c6_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
  ...
  cudaMemcpy(c6_b_gpu_blankMsg, chartInstance->c6_blankMsg, 2536UL,
             cudaMemcpyHostToDevice);
  cudaMemcpy(c6_gpu_msg, chartInstance->c6_msg, 2536UL, cudaMemcpyHostToDevice);
  c6_sf_gateway_c6_sliding_controller_const_kernel3<<<dim3(1U, 1U, 1U), dim3(32U,
    1U, 1U)>>>(c6_b_gpu_blankMsg, c6_gpu_msg);
  cudaMemcpy(chartInstance->c6_msg, c6_gpu_msg, 2536UL, cudaMemcpyDeviceToHost);
  cudaMemcpy(chartInstance->c6_blankMsg, c6_b_gpu_blankMsg, 2536UL,
             cudaMemcpyDeviceToHost);
  *(uint32_T *)&((char_T *)(c6_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
  ...
  *(uint32_T *)&((char_T *)(c6_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
  ...
  cudaMemcpy(c6_gpu_msg, chartInstance->c6_msg, 2536UL, cudaMemcpyHostToDevice);
  c6_sf_gateway_c6_sliding_controller_const_kernel4<<<dim3(1U, 1U, 1U), dim3
    (128U, 1U, 1U)>>>(c6_gpu_msg, c6_gpu_r);
  cudaMemcpy(chartInstance->c6_msg, c6_gpu_msg, 2536UL, cudaMemcpyDeviceToHost);
  ...
  for (c6_i5 = 0; c6_i5 < 16; c6_i5++) {
    cudaMemcpy(c6_gpu_r, &c6_r, 2536UL, cudaMemcpyHostToDevice);
    cudaMemcpy(c6_gpu_msg, chartInstance->c6_msg, 2536UL, cudaMemcpyHostToDevice);
    c6_sf_gateway_c6_sliding_controller_const_kernel5<<<dim3(1U, 1U, 1U), dim3
      (128U, 1U, 1U)>>>(c6_i5, c6_gpu_msg, c6_gpu_r);
    cudaMemcpy(chartInstance->c6_msg, c6_gpu_msg, 2536UL, cudaMemcpyDeviceToHost);
    cudaMemcpy(&c6_r, c6_gpu_r, 2536UL, cudaMemcpyDeviceToHost);
  ...
  cudaMemcpy(c6_gpu_r, &c6_r, 2536UL, cudaMemcpyHostToDevice);
  cudaMemcpy(c6_gpu_msg, chartInstance->c6_msg, 2536UL, cudaMemcpyHostToDevice);
  c6_sf_gateway_c6_sliding_controller_const_kernel6<<<dim3(1U, 1U, 1U), dim3(32U,
    1U, 1U)>>>(c6_gpu_msg, c6_gpu_r);
  cudaMemcpy(chartInstance->c6_msg, c6_gpu_msg, 2536UL, cudaMemcpyDeviceToHost);
  cudaMemcpy(&c6_r, c6_gpu_r, 2536UL, cudaMemcpyDeviceToHost);
  ...
  *(real_T *)&((char_T *)(c6_SL_Bus_sliding_controller_const_ros_time_Time *)
  ...
  cudaMemcpy(c6_gpu_r, &c6_r, 2536UL, cudaMemcpyHostToDevice);
  cudaMemcpy(c6_gpu_msg, chartInstance->c6_msg, 2536UL, cudaMemcpyHostToDevice);
  c6_sf_gateway_c6_sliding_controller_const_kernel7<<<dim3(1U, 1U, 1U), dim3
    (128U, 1U, 1U)>>>(c6_gpu_r, c6_gpu_msg);
  cudaMemcpy(chartInstance->c6_msg, c6_gpu_msg, 2536UL, cudaMemcpyDeviceToHost);
  *(uint32_T *)&((char_T *)(c6_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
    (c6_SL_Bus_sliding_controller_const_std_msgs_Header *)&((char_T *)
    chartInstance->c6_msg)[0])[152])[0] =
  ...
  *(uint32_T *)&((char_T *)(c6_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
  ...
  for (c6_i9 = 0; c6_i9 < 16; c6_i9++) {
    cudaMemcpy(c6_gpu_msg, chartInstance->c6_msg, 2536UL, cudaMemcpyHostToDevice);
    c6_sf_gateway_c6_sliding_controller_const_kernel8<<<dim3(1U, 1U, 1U), dim3
      (128U, 1U, 1U)>>>(c6_gpu_r, c6_i9, c6_gpu_msg);
    cudaMemcpy(chartInstance->c6_msg, c6_gpu_msg, 2536UL, cudaMemcpyDeviceToHost);
    *(uint32_T *)&((char_T *)(c6_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
      (c6_SL_Bus_sliding_controller_const_std_msgs_String *)&((char_T *)
      (c6_SL_Bus_sliding_controller_const_std_msgs_String *)&((char_T *)
  ...
  *(uint32_T *)&((char_T *)(c6_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
    chartInstance->c6_msg)[2464])[4] = c6_r.Velocity_SL_Info.ReceivedLength;
  cudaMemcpy(c6_gpu_msg, chartInstance->c6_msg, 2536UL, cudaMemcpyHostToDevice);
  c6_sf_gateway_c6_sliding_controller_const_kernel9<<<dim3(1U, 1U, 1U), dim3(32U,
    1U, 1U)>>>(c6_gpu_r, c6_gpu_msg);
  cudaMemcpy(chartInstance->c6_msg, c6_gpu_msg, 2536UL, cudaMemcpyDeviceToHost);
  *(uint32_T *)&((char_T *)(c6_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
    chartInstance->c6_msg)[2528])[0] = c6_r.Effort_SL_Info.CurrentLength;
  *(uint32_T *)&((char_T *)(c6_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
    chartInstance->c6_msg)[2528])[4] = c6_r.Effort_SL_Info.ReceivedLength;
  c6_do_animation_call_c6_sliding_controller_const(chartInstance);
...
const mxArray *sf_c6_sliding_controller_const_get_eml_resolved_functions_info()
{
   ...
   *c6_u, const emlrtMsgIdentifier *c6_parentId)
{
  ...
  c6_SL_Bus_sliding_controller_const_ros_time_Time c6_y;
  emlrtMsgIdentifier c6_thisId;
  c6_thisId.fParent = c6_parentId;
  c6_thisId.bParentIsCell = false;
  ...
  const char_T *c6_identifier)
{
  ...
  c6_y = c6_l_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_sliding_controller_const), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_sliding_controller_const);
  return c6_y;
}
...
static __global__ __launch_bounds__(128, 1) void
  c6_sf_gateway_c6_sliding_controller_const_kernel1
  (c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_blankMsg,
   c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_msg)
{
...
static __global__ __launch_bounds__(128, 1) void
  c6_sf_gateway_c6_sliding_controller_const_kernel2(const int32_T c6_i1,
  c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_blankMsg,
  c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_msg)
{
  uint64_T c6_threadId;
...
static __global__ __launch_bounds__(32, 1) void
  c6_sf_gateway_c6_sliding_controller_const_kernel3
  (c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_blankMsg,
   c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_msg)
{
  uint64_T c6_threadId;
...
static __global__ __launch_bounds__(128, 1) void
  c6_sf_gateway_c6_sliding_controller_const_kernel4
  (c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_msg,
   c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_r)
{
  uint64_T c6_threadId;
...
static __global__ __launch_bounds__(128, 1) void
  c6_sf_gateway_c6_sliding_controller_const_kernel5(const int32_T c6_i5,
  c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_msg,
  c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_r)
{
  uint64_T c6_threadId;
...
static __global__ __launch_bounds__(32, 1) void
  c6_sf_gateway_c6_sliding_controller_const_kernel6
  (c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_msg,
   c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_r)
{
  uint64_T c6_threadId;
...
static __global__ __launch_bounds__(128, 1) void
  c6_sf_gateway_c6_sliding_controller_const_kernel7(const
  c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_r,
  c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_msg)
{
  uint64_T c6_threadId;
...
static __global__ __launch_bounds__(128, 1) void
  c6_sf_gateway_c6_sliding_controller_const_kernel8(const
  c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_r, const int32_T
  c6_i9, c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_msg)
{
  uint64_T c6_threadId;
...
static __global__ __launch_bounds__(32, 1) void
  c6_sf_gateway_c6_sliding_controller_const_kernel9(const
  c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_r,
  c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *c6_b_msg)
{
  uint64_T c6_threadId;
...
static __global__ __launch_bounds__(32, 1) void c6_eML_blk_kernel_kernel11(const
  uint8_T c6_uv[10], c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState
  *c6_b_blankMsg)
{
  uint64_T c6_threadId;
  int32_T c6_i;
...
static __global__ __launch_bounds__(32, 1) void c6_eML_blk_kernel_kernel13(const
  uint8_T c6_uv1[11], c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *
  c6_b_blankMsg)
{
  uint64_T c6_threadId;
  int32_T c6_i1;
...
static __global__ __launch_bounds__(32, 1) void c6_eML_blk_kernel_kernel15(const
  uint8_T c6_uv2[12], c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *
  c6_b_blankMsg)
{
  uint64_T c6_threadId;
  int32_T c6_i2;
...
static __global__ __launch_bounds__(32, 1) void c6_eML_blk_kernel_kernel17(const
  uint8_T c6_uv3[11], c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *
  c6_b_blankMsg)
{
  uint64_T c6_threadId;
  int32_T c6_i3;
...
static __global__ __launch_bounds__(32, 1) void c6_eML_blk_kernel_kernel19(const
  uint8_T c6_uv4[12], c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *
  c6_b_blankMsg)
{
  uint64_T c6_threadId;
  int32_T c6_i4;
...
static __global__ __launch_bounds__(32, 1) void c6_eML_blk_kernel_kernel21(const
  uint8_T c6_uv5[13], c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *
  c6_b_blankMsg)
{
  uint64_T c6_threadId;
  int32_T c6_i5;
...
static __global__ __launch_bounds__(32, 1) void c6_eML_blk_kernel_kernel23(const
  uint8_T c6_uv6[8], c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState
  *c6_b_blankMsg)
{
  uint64_T c6_threadId;
  int32_T c6_i6;
  ...
  *chartInstance)
{
  ...
  chartInstance->c6_blankMsg =
    (c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *)
    ssGetInputPortSignal_wrapper(chartInstance->S, 0);
  chartInstance->c6_msg =
    (c6_SL_Bus_sliding_controller_const_sensor_msgs_JointState *)
...
/* SFunction Glue Code */
void sf_c6_sliding_controller_const_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2304358722U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1910441188U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(48708520U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2323613758U);
}

mxArray *sf_c6_sliding_controller_const_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_sliding_controller_const_jit_fallback_info(void)
{
...
mxArray *sf_c6_sliding_controller_const_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c6_sliding_controller_const(void)
{
  ...
  mxArray *mxVarInfo = sf_mex_decode(
    ...
    "H2RxBwvyqK+yH8zOL4xOSSzLLU+GSz+OKczJTMvPT45Py8kqL8nJzUIhCzuAQW/0AAAEa7HtY="
    );
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_sliding_controller_const_get_check_sum(&mxChecksum);
...
{
  return "sFzHDR1xQZs9wz904y9XX1D";
}

static void sf_opaque_initialize_c6_sliding_controller_const(void
  *chartInstanceVar)
{
  initialize_params_c6_sliding_controller_const
    ((SFc6_sliding_controller_constInstanceStruct*) chartInstanceVar);
  initialize_c6_sliding_controller_const
    ((SFc6_sliding_controller_constInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_sliding_controller_const(void *chartInstanceVar)
{
  enable_c6_sliding_controller_const
    ((SFc6_sliding_controller_constInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_sliding_controller_const(void *chartInstanceVar)
{
  disable_c6_sliding_controller_const
    ((SFc6_sliding_controller_constInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_sliding_controller_const(void *chartInstanceVar)
{
  sf_gateway_c6_sliding_controller_const
    ((SFc6_sliding_controller_constInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c6_sliding_controller_const
  (SimStruct* S)
{
  return get_sim_state_c6_sliding_controller_const
    ((SFc6_sliding_controller_constInstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c6_sliding_controller_const(SimStruct* S,
  const mxArray *st)
{
  set_sim_state_c6_sliding_controller_const
    ((SFc6_sliding_controller_constInstanceStruct*)sf_get_chart_instance_ptr(S),
     st);
}

static void sf_opaque_cleanup_runtime_resources_c6_sliding_controller_const(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_sliding_controller_constInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    mdl_cleanup_runtime_resources_c6_sliding_controller_const
      ((SFc6_sliding_controller_constInstanceStruct*) chartInstanceVar);
    ((SFc6_sliding_controller_constInstanceStruct*) chartInstanceVar)->
      ~SFc6_sliding_controller_constInstanceStruct();
...
static void sf_opaque_mdl_start_c6_sliding_controller_const(void
  *chartInstanceVar)
{
  mdl_start_c6_sliding_controller_const
    ((SFc6_sliding_controller_constInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_mdl_terminate_c6_sliding_controller_const(void
  *chartInstanceVar)
{
  mdl_terminate_c6_sliding_controller_const
    ((SFc6_sliding_controller_constInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_init_subchart_simstructs(void *chartInstanceVar)
{
  initSimStructsc6_sliding_controller_const
    ((SFc6_sliding_controller_constInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_sliding_controller_const(SimStruct *S)
{
  int i;
...
const char* sf_c6_sliding_controller_const_get_post_codegen_info(void)
{
  ...
  const char* encStrCodegen [18] = {
    "eNrtV91u00gUdkNBRWJpWSG4QVpu0O4lldCKCglK8yMipdsubkvFTTUdn8SzGc+Y+UmavsO+y17",
    "tg3DFY8Be78WesZ00dWynJaICtJZcZ+zvnDnnfOdn6i21tz28buO9+aPn3cDnCt41L72uZ+ulqT",
    "t9v+z9nK3/RCFho12iSKS9ykuQCF6DltwaJkVbdGUhjIkuKBAUsbFUpkybZpHlTPRbVlCnT78JG",
    "Q39UFoebKEsCXYEH6G22Jpd1NNgCqhpAQQmVNL2whYnvYnFygzrIdC+tlGVCxqMb2Nnlt623LCY",
    "Q/MEaFtoQ9BifWabb4iBujkpddN5qv0xUEYxZ0QUehsS7UOMATawHwf4d8cadCoPoyFRZgtCMgD",
    "dYf1EpxSQ18k0fjhmghipGOHNiNed4Kxtuxzt2ZYB8IqAoG1bCkg/lkyYcv79FnraFOSYQwOOba",
    "9cmw/vrCP/gMEQVGncunU5AEV6sCNKN00C0jxJ2JpkySzMsAgOiHpJkT8NQWn2YuZonyBPsIcSZ",
    "TBInGzrPcUGGN5SbTZqu8ycVzI2SsnW82CJtuYAqliYaGtRUSec61LYnow7MACeaG0QQ6phqdZi",
    "nNYs2JMYYJfe5dVgBUPiM1hdioAV0jXIAZK+8xs2lvNIarWRUR2Tt9HpzH6ehbWFAdUlFIq6gCJ",
    "MA8YsCW+5toBpxz0C0SqTmFcETjNkHsrTXSsaQ6n6GJOKJnLmgmO0FBjpHnKJlbCvsWiqYI7LeT",
    "hKaAiBazCMwzaWDWILYqJda3uJdTdgZtQATRWLC1i1WHXYhpouoUYx7Iu+kEPRUjLysx6fhhcAs",
    "40owURvC/uXGrVw9yIq3Dx77J3Ns1sXmGdjufzzlyk9SwV6vKlnft+btep9a/hraTx/p+R+yO2z",
    "nJNzuDW8/+g8W/3n498r77v/3lm9d/ppkf3/ql1u/t/O1g/GjXZSOIOZfHXYV1N2LRfovz+lfy1",
    "b69bpq8br9ZPf3+qN4enG4yejjcPD9UbKzxx7azl7x+8fuo6PWZbkp6LtIDuYuDWx6bh2+p9O2X",
    "tjTjxuZu/T6+OLxeTvbuZ5LIrXtXPxuuYq91zefv7+DzcXk0/3P5xj/6Mc34+SuX5EXLeAI/rrk",
    "eYswEo/olIYJTkH5X5qk6vPz833y8p5Vyz3rdj5v9yX5/0i8+uq5bwrllvUv8vO8a8NXzUPvBx+",
    "7Sv2Y9Hz1ZfGf/Audw76KVs/n/yrUw8ZDwpOvdlnPMJ2i75+B3n6H349tNU=",
    ""
  };
...
static void mdlSetWorkWidths_c6_sliding_controller_const(SimStruct *S)
{
  const char* newstr = sf_c6_sliding_controller_const_get_post_codegen_info();
  sf_set_work_widths(S, newstr);
  ssSetChecksum0(S,(255544426U));
  ssSetChecksum1(S,(146206962U));
  ssSetChecksum2(S,(301754066U));
  ssSetChecksum3(S,(4051310095U));
}

static void mdlRTW_c6_sliding_controller_const(SimStruct *S)
{
...
static void mdlSetupRuntimeResources_c6_sliding_controller_const(SimStruct *S)
{
  SFc6_sliding_controller_constInstanceStruct *chartInstance;
  chartInstance = (SFc6_sliding_controller_constInstanceStruct *)utMalloc(sizeof
    (SFc6_sliding_controller_constInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc6_sliding_controller_constInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_sliding_controller_const;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_sliding_controller_const;
  chartInstance->chartInfo.mdlStart =
    sf_opaque_mdl_start_c6_sliding_controller_const;
  chartInstance->chartInfo.mdlTerminate =
    sf_opaque_mdl_terminate_c6_sliding_controller_const;
  chartInstance->chartInfo.mdlCleanupRuntimeResources =
    sf_opaque_cleanup_runtime_resources_c6_sliding_controller_const;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c6_sliding_controller_const;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c6_sliding_controller_const;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_sliding_controller_const;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_sliding_controller_const;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_sliding_controller_const;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_sliding_controller_const;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_sliding_controller_const;
  ...
  mdl_setup_runtime_resources_c6_sliding_controller_const(chartInstance);
}

void c6_sliding_controller_const_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_SETUP_RUNTIME_RESOURCES:
    mdlSetupRuntimeResources_c6_sliding_controller_const(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_sliding_controller_const(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_sliding_controller_const(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_sliding_controller_const_method_dispatcher.\n"
