...
static void initialize_c8_sliding_controller2
  (SFc8_sliding_controller2InstanceStruct *chartInstance);
static void initialize_params_c8_sliding_controller2
  (SFc8_sliding_controller2InstanceStruct *chartInstance);
static void enable_c8_sliding_controller2(SFc8_sliding_controller2InstanceStruct
  *chartInstance);
static void disable_c8_sliding_controller2
  (SFc8_sliding_controller2InstanceStruct *chartInstance);
static void c8_do_animation_call_c8_sliding_controller2
  (SFc8_sliding_controller2InstanceStruct *chartInstance);
static void ext_mode_exec_c8_sliding_controller2
  (SFc8_sliding_controller2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_sliding_controller2
  (SFc8_sliding_controller2InstanceStruct *chartInstance);
static void set_sim_state_c8_sliding_controller2
  (SFc8_sliding_controller2InstanceStruct *chartInstance, const mxArray *c8_st);
static void sf_gateway_c8_sliding_controller2
  (SFc8_sliding_controller2InstanceStruct *chartInstance);
static void mdl_start_c8_sliding_controller2
  (SFc8_sliding_controller2InstanceStruct *chartInstance);
static void mdl_terminate_c8_sliding_controller2
  (SFc8_sliding_controller2InstanceStruct *chartInstance);
static void mdl_setup_runtime_resources_c8_sliding_controller2
  (SFc8_sliding_controller2InstanceStruct *chartInstance);
static void mdl_cleanup_runtime_resources_c8_sliding_controller2
  (SFc8_sliding_controller2InstanceStruct *chartInstance);
static void initSimStructsc8_sliding_controller2
  (SFc8_sliding_controller2InstanceStruct *chartInstance);
static void c8_emlrt_marshallIn(SFc8_sliding_controller2InstanceStruct
  *chartInstance, const mxArray *c8_b_msg, const char_T *c8_identifier,
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_y);
static void c8_b_emlrt_marshallIn(SFc8_sliding_controller2InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_y);
static void c8_c_emlrt_marshallIn(SFc8_sliding_controller2InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  c8_SL_Bus_sliding_controller2_std_msgs_Header *c8_y);
static uint32_T c8_d_emlrt_marshallIn(SFc8_sliding_controller2InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static c8_SL_Bus_sliding_controller2_ros_time_Time c8_e_emlrt_marshallIn
  (SFc8_sliding_controller2InstanceStruct *chartInstance, const mxArray *c8_u,
   const emlrtMsgIdentifier *c8_parentId);
static real_T c8_f_emlrt_marshallIn(SFc8_sliding_controller2InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_g_emlrt_marshallIn(SFc8_sliding_controller2InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  uint8_T c8_y[128]);
static c8_SL_Bus_ROSVariableLengthArrayInfo c8_h_emlrt_marshallIn
  (SFc8_sliding_controller2InstanceStruct *chartInstance, const mxArray *c8_u,
   const emlrtMsgIdentifier *c8_parentId);
static void c8_i_emlrt_marshallIn(SFc8_sliding_controller2InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  c8_SL_Bus_sliding_controller2_std_msgs_String c8_y[16]);
static void c8_j_emlrt_marshallIn(SFc8_sliding_controller2InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  real_T c8_y[7]);
static uint8_T c8_k_emlrt_marshallIn(SFc8_sliding_controller2InstanceStruct
  *chartInstance, const mxArray *c8_b_is_active_c8_sliding_controller2, const
  char_T *c8_identifier);
static uint8_T c8_l_emlrt_marshallIn(SFc8_sliding_controller2InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_eML_blk_kernel(SFc8_sliding_controller2InstanceStruct
  *chartInstance, c8_SL_Bus_sliding_controller2_sensor_msgs_JointState
  *c8_b_blankMsg);
static __global__ void c8_sf_gateway_c8_sliding_controller2_kernel1
  (c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_blankMsg,
   c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_msg);
static __global__ void c8_sf_gateway_c8_sliding_controller2_kernel2(const
  int32_T c8_i1, c8_SL_Bus_sliding_controller2_sensor_msgs_JointState
  *c8_b_blankMsg, c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_msg);
static __global__ void c8_sf_gateway_c8_sliding_controller2_kernel3
  (c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_blankMsg,
   c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_msg);
static __global__ void c8_sf_gateway_c8_sliding_controller2_kernel4
  (c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_msg,
   c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_r);
static __global__ void c8_sf_gateway_c8_sliding_controller2_kernel5(const
  int32_T c8_i5, c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_msg,
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_r);
static __global__ void c8_sf_gateway_c8_sliding_controller2_kernel6
  (c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_msg,
   c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_r);
static __global__ void c8_sf_gateway_c8_sliding_controller2_kernel7(const
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_r,
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_msg);
static __global__ void c8_sf_gateway_c8_sliding_controller2_kernel8(const
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_r, const int32_T
  c8_i9, c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_msg);
static __global__ void c8_sf_gateway_c8_sliding_controller2_kernel9(const
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_r,
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_msg);
...
static __global__ void c8_eML_blk_kernel_kernel22
  (c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_blankMsg);
static void init_dsm_address_info(SFc8_sliding_controller2InstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc8_sliding_controller2InstanceStruct
  *chartInstance);
  ...
  (SFc8_sliding_controller2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_sliding_controller2 = 0U;
  cudaGetLastError();
  ...
  (SFc8_sliding_controller2InstanceStruct *chartInstance)
{
  ...
  c8_SL_Bus_sliding_controller2_std_msgs_String c8_g_u[16];
  const c8_SL_Bus_sliding_controller2_std_msgs_String *c8_r;
  ...
  c8_u_Seq = *(uint32_T *)&((char_T *)
    (c8_SL_Bus_sliding_controller2_std_msgs_Header *)&((char_T *)
    chartInstance->c8_msg)[0])[0];
  c8_u_Stamp_Sec = *(real_T *)&((char_T *)
    (c8_SL_Bus_sliding_controller2_ros_time_Time *)&((char_T *)
    (c8_SL_Bus_sliding_controller2_std_msgs_Header *)&((char_T *)
  ...
  for (c8_i2 = 0; c8_i2 < 16; c8_i2++) {
    for (c8_i3 = 0; c8_i3 < 128; c8_i3++) {
      c8_g_u[c8_i2].Data[c8_i3] = ((uint8_T *)&((char_T *)
        (c8_SL_Bus_sliding_controller2_std_msgs_String *)&((char_T *)
        (c8_SL_Bus_sliding_controller2_std_msgs_String *)&((char_T *)
  ...
  sf_mex_assign(&c8_gb_y, sf_mex_create("y",
    &chartInstance->c8_is_active_c8_sliding_controller2, 3, 0U, 0U, 0U, 0),
                false);
  ...
  (SFc8_sliding_controller2InstanceStruct *chartInstance, const mxArray *c8_st)
{
  ...
  c8_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 0)), "msg",
                      &c8_r);
  *(uint32_T *)&((char_T *)(c8_SL_Bus_sliding_controller2_std_msgs_Header *)
                 &((char_T *)chartInstance->c8_msg)[0])[0] = c8_r.Header.Seq;
  *(real_T *)&((char_T *)(c8_SL_Bus_sliding_controller2_ros_time_Time *)
               &((char_T *)(c8_SL_Bus_sliding_controller2_std_msgs_Header *)
  ...
  *(real_T *)&((char_T *)(c8_SL_Bus_sliding_controller2_ros_time_Time *)
  ...
  for (c8_i = 0; c8_i < 128; c8_i++) {
    ((uint8_T *)&((char_T *)(c8_SL_Bus_sliding_controller2_std_msgs_Header *)
  ...
  *(uint32_T *)&((char_T *)(c8_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
  ...
  for (c8_i1 = 0; c8_i1 < 16; c8_i1++) {
    for (c8_i2 = 0; c8_i2 < 128; c8_i2++) {
      ((uint8_T *)&((char_T *)(c8_SL_Bus_sliding_controller2_std_msgs_String *)
                    &((char_T *)(c8_SL_Bus_sliding_controller2_std_msgs_String *)
  ...
  *(uint32_T *)&((char_T *)(c8_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
  ...
  chartInstance->c8_is_active_c8_sliding_controller2 = c8_k_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 1)),
     "is_active_c8_sliding_controller2");
  sf_mex_destroy(&c8_u);
...
{
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState c8_r;
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_gpu_blankMsg;
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_gpu_msg;
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_gpu_r;
  int32_T c8_i1;
  int32_T c8_i5;
  int32_T c8_i9;
  ...
  *(uint32_T *)&((char_T *)(c8_SL_Bus_sliding_controller2_std_msgs_Header *)
    ...
    &((char_T *)(c8_SL_Bus_sliding_controller2_std_msgs_Header *)&((char_T *)
       chartInstance->c8_blankMsg)[0])[0];
  *(real_T *)&((char_T *)(c8_SL_Bus_sliding_controller2_ros_time_Time *)
               &((char_T *)(c8_SL_Bus_sliding_controller2_std_msgs_Header *)
                 &((char_T *)chartInstance->c8_msg)[0])[8])[0] = *(real_T *)
    &((char_T *)(c8_SL_Bus_sliding_controller2_ros_time_Time *)&((char_T *)
       (c8_SL_Bus_sliding_controller2_std_msgs_Header *)&((char_T *)
  ...
  *(real_T *)&((char_T *)(c8_SL_Bus_sliding_controller2_ros_time_Time *)
  ...
  c8_sf_gateway_c8_sliding_controller2_kernel1<<<dim3(1U, 1U, 1U), dim3(128U, 1U,
    1U)>>>(c8_b_gpu_blankMsg, c8_gpu_msg);
  ...
  *(uint32_T *)&((char_T *)(c8_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
  ...
  for (c8_i1 = 0; c8_i1 < 16; c8_i1++) {
    cudaMemcpy(c8_b_gpu_blankMsg, chartInstance->c8_blankMsg, 2536UL,
               cudaMemcpyHostToDevice);
    cudaMemcpy(c8_gpu_msg, chartInstance->c8_msg, 2536UL, cudaMemcpyHostToDevice);
    c8_sf_gateway_c8_sliding_controller2_kernel2<<<dim3(1U, 1U, 1U), dim3(128U,
      1U, 1U)>>>(c8_i1, c8_b_gpu_blankMsg, c8_gpu_msg);
    cudaMemcpy(chartInstance->c8_msg, c8_gpu_msg, 2536UL, cudaMemcpyDeviceToHost);
    cudaMemcpy(chartInstance->c8_blankMsg, c8_b_gpu_blankMsg, 2536UL,
               cudaMemcpyDeviceToHost);
    *(uint32_T *)&((char_T *)(c8_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
  ...
  *(uint32_T *)&((char_T *)(c8_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
  ...
  cudaMemcpy(c8_b_gpu_blankMsg, chartInstance->c8_blankMsg, 2536UL,
             cudaMemcpyHostToDevice);
  cudaMemcpy(c8_gpu_msg, chartInstance->c8_msg, 2536UL, cudaMemcpyHostToDevice);
  c8_sf_gateway_c8_sliding_controller2_kernel3<<<dim3(1U, 1U, 1U), dim3(32U, 1U,
    1U)>>>(c8_b_gpu_blankMsg, c8_gpu_msg);
  cudaMemcpy(chartInstance->c8_msg, c8_gpu_msg, 2536UL, cudaMemcpyDeviceToHost);
  cudaMemcpy(chartInstance->c8_blankMsg, c8_b_gpu_blankMsg, 2536UL,
             cudaMemcpyDeviceToHost);
  ...
  *(uint32_T *)&((char_T *)(c8_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
  ...
  cudaMemcpy(c8_gpu_msg, chartInstance->c8_msg, 2536UL, cudaMemcpyHostToDevice);
  c8_sf_gateway_c8_sliding_controller2_kernel4<<<dim3(1U, 1U, 1U), dim3(128U, 1U,
    1U)>>>(c8_gpu_msg, c8_gpu_r);
  cudaMemcpy(chartInstance->c8_msg, c8_gpu_msg, 2536UL, cudaMemcpyDeviceToHost);
  ...
  for (c8_i5 = 0; c8_i5 < 16; c8_i5++) {
    cudaMemcpy(c8_gpu_r, &c8_r, 2536UL, cudaMemcpyHostToDevice);
    cudaMemcpy(c8_gpu_msg, chartInstance->c8_msg, 2536UL, cudaMemcpyHostToDevice);
    c8_sf_gateway_c8_sliding_controller2_kernel5<<<dim3(1U, 1U, 1U), dim3(128U,
      1U, 1U)>>>(c8_i5, c8_gpu_msg, c8_gpu_r);
    cudaMemcpy(chartInstance->c8_msg, c8_gpu_msg, 2536UL, cudaMemcpyDeviceToHost);
    cudaMemcpy(&c8_r, c8_gpu_r, 2536UL, cudaMemcpyDeviceToHost);
  ...
  cudaMemcpy(c8_gpu_r, &c8_r, 2536UL, cudaMemcpyHostToDevice);
  cudaMemcpy(c8_gpu_msg, chartInstance->c8_msg, 2536UL, cudaMemcpyHostToDevice);
  c8_sf_gateway_c8_sliding_controller2_kernel6<<<dim3(1U, 1U, 1U), dim3(32U, 1U,
    1U)>>>(c8_gpu_msg, c8_gpu_r);
  cudaMemcpy(chartInstance->c8_msg, c8_gpu_msg, 2536UL, cudaMemcpyDeviceToHost);
  cudaMemcpy(&c8_r, c8_gpu_r, 2536UL, cudaMemcpyDeviceToHost);
  ...
  *(real_T *)&((char_T *)(c8_SL_Bus_sliding_controller2_ros_time_Time *)
  ...
  cudaMemcpy(c8_gpu_r, &c8_r, 2536UL, cudaMemcpyHostToDevice);
  cudaMemcpy(c8_gpu_msg, chartInstance->c8_msg, 2536UL, cudaMemcpyHostToDevice);
  c8_sf_gateway_c8_sliding_controller2_kernel7<<<dim3(1U, 1U, 1U), dim3(128U, 1U,
    1U)>>>(c8_gpu_r, c8_gpu_msg);
  cudaMemcpy(chartInstance->c8_msg, c8_gpu_msg, 2536UL, cudaMemcpyDeviceToHost);
  *(uint32_T *)&((char_T *)(c8_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
    (c8_SL_Bus_sliding_controller2_std_msgs_Header *)&((char_T *)
    chartInstance->c8_msg)[0])[152])[0] =
  ...
  *(uint32_T *)&((char_T *)(c8_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
  ...
  for (c8_i9 = 0; c8_i9 < 16; c8_i9++) {
    cudaMemcpy(c8_gpu_msg, chartInstance->c8_msg, 2536UL, cudaMemcpyHostToDevice);
    c8_sf_gateway_c8_sliding_controller2_kernel8<<<dim3(1U, 1U, 1U), dim3(128U,
      1U, 1U)>>>(c8_gpu_r, c8_i9, c8_gpu_msg);
    cudaMemcpy(chartInstance->c8_msg, c8_gpu_msg, 2536UL, cudaMemcpyDeviceToHost);
    *(uint32_T *)&((char_T *)(c8_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
      (c8_SL_Bus_sliding_controller2_std_msgs_String *)&((char_T *)
      (c8_SL_Bus_sliding_controller2_std_msgs_String *)&((char_T *)
  ...
  *(uint32_T *)&((char_T *)(c8_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
    chartInstance->c8_msg)[2464])[4] = c8_r.Velocity_SL_Info.ReceivedLength;
  cudaMemcpy(c8_gpu_msg, chartInstance->c8_msg, 2536UL, cudaMemcpyHostToDevice);
  c8_sf_gateway_c8_sliding_controller2_kernel9<<<dim3(1U, 1U, 1U), dim3(32U, 1U,
    1U)>>>(c8_gpu_r, c8_gpu_msg);
  cudaMemcpy(chartInstance->c8_msg, c8_gpu_msg, 2536UL, cudaMemcpyDeviceToHost);
  *(uint32_T *)&((char_T *)(c8_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
    chartInstance->c8_msg)[2528])[0] = c8_r.Effort_SL_Info.CurrentLength;
  *(uint32_T *)&((char_T *)(c8_SL_Bus_ROSVariableLengthArrayInfo *)&((char_T *)
    chartInstance->c8_msg)[2528])[4] = c8_r.Effort_SL_Info.ReceivedLength;
  c8_do_animation_call_c8_sliding_controller2(chartInstance);
...
const mxArray *sf_c8_sliding_controller2_get_eml_resolved_functions_info()
{
   ...
   const emlrtMsgIdentifier *c8_parentId)
{
  ...
  c8_SL_Bus_sliding_controller2_ros_time_Time c8_y;
  emlrtMsgIdentifier c8_thisId;
  c8_thisId.fParent = c8_parentId;
  c8_thisId.bParentIsCell = false;
  ...
  char_T *c8_identifier)
{
  ...
  c8_y = c8_l_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_sliding_controller2), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_sliding_controller2);
  return c8_y;
}
...
static __global__ __launch_bounds__(128, 1) void
  c8_sf_gateway_c8_sliding_controller2_kernel1
  (c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_blankMsg,
   c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_msg)
{
...
static __global__ __launch_bounds__(128, 1) void
  c8_sf_gateway_c8_sliding_controller2_kernel2(const int32_T c8_i1,
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_blankMsg,
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_msg)
{
  uint64_T c8_threadId;
...
static __global__ __launch_bounds__(32, 1) void
  c8_sf_gateway_c8_sliding_controller2_kernel3
  (c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_blankMsg,
   c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_msg)
{
  uint64_T c8_threadId;
...
static __global__ __launch_bounds__(128, 1) void
  c8_sf_gateway_c8_sliding_controller2_kernel4
  (c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_msg,
   c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_r)
{
  uint64_T c8_threadId;
...
static __global__ __launch_bounds__(128, 1) void
  c8_sf_gateway_c8_sliding_controller2_kernel5(const int32_T c8_i5,
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_msg,
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_r)
{
  uint64_T c8_threadId;
...
static __global__ __launch_bounds__(32, 1) void
  c8_sf_gateway_c8_sliding_controller2_kernel6
  (c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_msg,
   c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_r)
{
  uint64_T c8_threadId;
...
static __global__ __launch_bounds__(128, 1) void
  c8_sf_gateway_c8_sliding_controller2_kernel7(const
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_r,
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_msg)
{
  uint64_T c8_threadId;
...
static __global__ __launch_bounds__(128, 1) void
  c8_sf_gateway_c8_sliding_controller2_kernel8(const
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_r, const int32_T
  c8_i9, c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_msg)
{
  uint64_T c8_threadId;
...
static __global__ __launch_bounds__(32, 1) void
  c8_sf_gateway_c8_sliding_controller2_kernel9(const
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_r,
  c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *c8_b_msg)
{
  uint64_T c8_threadId;
...
static __global__ __launch_bounds__(32, 1) void c8_eML_blk_kernel_kernel11(const
  uint8_T c8_uv[12], c8_SL_Bus_sliding_controller2_sensor_msgs_JointState
  *c8_b_blankMsg)
{
  uint64_T c8_threadId;
  int32_T c8_i;
...
static __global__ __launch_bounds__(32, 1) void c8_eML_blk_kernel_kernel13(const
  uint8_T c8_uv1[13], c8_SL_Bus_sliding_controller2_sensor_msgs_JointState
  *c8_b_blankMsg)
{
  uint64_T c8_threadId;
  int32_T c8_i1;
...
static __global__ __launch_bounds__(32, 1) void c8_eML_blk_kernel_kernel15(const
  uint8_T c8_uv2[14], c8_SL_Bus_sliding_controller2_sensor_msgs_JointState
  *c8_b_blankMsg)
{
  uint64_T c8_threadId;
  int32_T c8_i2;
...
static __global__ __launch_bounds__(32, 1) void c8_eML_blk_kernel_kernel17(const
  uint8_T c8_uv3[13], c8_SL_Bus_sliding_controller2_sensor_msgs_JointState
  *c8_b_blankMsg)
{
  uint64_T c8_threadId;
  int32_T c8_i3;
...
static __global__ __launch_bounds__(32, 1) void c8_eML_blk_kernel_kernel19(const
  uint8_T c8_uv4[14], c8_SL_Bus_sliding_controller2_sensor_msgs_JointState
  *c8_b_blankMsg)
{
  uint64_T c8_threadId;
  int32_T c8_i4;
...
static __global__ __launch_bounds__(32, 1) void c8_eML_blk_kernel_kernel21(const
  uint8_T c8_uv5[15], c8_SL_Bus_sliding_controller2_sensor_msgs_JointState
  *c8_b_blankMsg)
{
  uint64_T c8_threadId;
  int32_T c8_i5;
  ...
  *chartInstance)
{
  ...
  chartInstance->c8_blankMsg =
    (c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *)
    ssGetInputPortSignal_wrapper(chartInstance->S, 0);
  chartInstance->c8_msg = (c8_SL_Bus_sliding_controller2_sensor_msgs_JointState *)
...
/* SFunction Glue Code */
void sf_c8_sliding_controller2_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2560020070U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2485241930U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1610011318U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2621926977U);
}

mxArray *sf_c8_sliding_controller2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_sliding_controller2_jit_fallback_info(void)
{
...
mxArray *sf_c8_sliding_controller2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c8_sliding_controller2(void)
{
  ...
  mxArray *mxVarInfo = sf_mex_decode(
    ...
    "BMP8T+AALuV0BxP4SfWRyfmFySWZYan2wRX5yTmZKZlx6fnJ9XUpSfk5NaZATzHwAnqB1p"
    );
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_sliding_controller2_get_check_sum(&mxChecksum);
...
{
  return "sYLA1HBLp0f6BprwjY7zn1D";
}

static void sf_opaque_initialize_c8_sliding_controller2(void *chartInstanceVar)
{
  initialize_params_c8_sliding_controller2
    ((SFc8_sliding_controller2InstanceStruct*) chartInstanceVar);
  initialize_c8_sliding_controller2((SFc8_sliding_controller2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c8_sliding_controller2(void *chartInstanceVar)
{
  enable_c8_sliding_controller2((SFc8_sliding_controller2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c8_sliding_controller2(void *chartInstanceVar)
{
  disable_c8_sliding_controller2((SFc8_sliding_controller2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c8_sliding_controller2(void *chartInstanceVar)
{
  sf_gateway_c8_sliding_controller2((SFc8_sliding_controller2InstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c8_sliding_controller2(SimStruct*
  S)
{
  return get_sim_state_c8_sliding_controller2
    ((SFc8_sliding_controller2InstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c8_sliding_controller2(SimStruct* S, const
  mxArray *st)
{
  set_sim_state_c8_sliding_controller2((SFc8_sliding_controller2InstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_cleanup_runtime_resources_c8_sliding_controller2(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_sliding_controller2InstanceStruct*) chartInstanceVar
      )->S;
    ...
    mdl_cleanup_runtime_resources_c8_sliding_controller2
      ((SFc8_sliding_controller2InstanceStruct*) chartInstanceVar);
    ((SFc8_sliding_controller2InstanceStruct*) chartInstanceVar)->
      ~SFc8_sliding_controller2InstanceStruct();
...
static void sf_opaque_mdl_start_c8_sliding_controller2(void *chartInstanceVar)
{
  mdl_start_c8_sliding_controller2((SFc8_sliding_controller2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_mdl_terminate_c8_sliding_controller2(void
  *chartInstanceVar)
{
  mdl_terminate_c8_sliding_controller2((SFc8_sliding_controller2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_init_subchart_simstructs(void *chartInstanceVar)
{
  initSimStructsc8_sliding_controller2((SFc8_sliding_controller2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_sliding_controller2(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c8_sliding_controller2
      ((SFc8_sliding_controller2InstanceStruct*)sf_get_chart_instance_ptr(S));
    initSimStructsc8_sliding_controller2((SFc8_sliding_controller2InstanceStruct*)
...
const char* sf_c8_sliding_controller2_get_post_codegen_info(void)
{
  ...
  const char* encStrCodegen [18] = {
    "eNrtV09v00gUd0JBIEFVrVbaCxK9wRE4sFzYbeMkECmlFW5Zcaqm45d4NuMZ7/xJWs4ITnwE7nw",
    "kvgHihsSFI29sN00d26EEKna1llx37N/7zfv/Jl6jt+XhtYr3/V887xI+L+Pd9LLrYr5uzNzZ+x",
    "XvZr5+jULCxjtEkVh7tZcgMTwBLbk1TIqeGMhSGBMDUCAoYhOpTBWbZrHlTIy6VlDHp/+KGI2CS",
    "FoetlCWhNuCHyFbYs0O8rSZAmq6AKGJlLTDqMvJcKqxMhM/AjrSNq4zQYMJbOLU0luWG5Zw6BwC",
    "7QltCGqsT3QLDDHgm8NKM52lOjgGyjjhjIhSayOiA0jQwQb2khD/bluDRhVhNCLKtCAiY9B9Nko",
    "5pYAiJ9P44YAJYqRihHdi7jvBed12OOqzJUPgNQ5B3VoKyCiRTJjq+AddtLQjyAGHNhzYYTVbAP",
    "9YF/ynDCagKv028OUYFBnCtqjcNHVI5zCN1jRL5mGGxfCUqE2K8dMQVmYvZo4OCMYJdlGiCgapk",
    "T29q9gY3VvJZuOey8xFJWPjLNh6ESxl64yhLgpTti4VPuFcV8J2ZdKHMfCUtU0MqYdlrOU4rVm4",
    "K9HBLr2rq8EKhoHPYb4UISsN17gASPvOY2wsp5HUaiNjH5O33e/Pf56H9YQBNSAUyrqAIkwD+ix",
    "1bzVbyLSLPQJRK5OqVwbOMmQRytMDK9oTqUbok5omcmKCi2glMNZDjCVWwp7GoqmDuVguwlFCIw",
    "hdg2EctrBsEFviE+1a2ybW3ZiZozZoqlhSElWLVYdtqOMS6iiBPTESciK6SsZB3uMz9wJgthElm",
    "Bi2sH+poy7uXhYKN89ueyfz7OpXzLNjueLz1gxPo4THm3kW973SrN+3if81crmNGblrhX1WCnIO",
    "t+Yy6cm90YOH/mDj5ZtPH169f7HM/m+bZ5v/q/n6+nGjnRbOeC5fHfbRjF4rJfy/zfCv5Wv9rL9",
    "551Grn9we3GslavL3s9+fizvtlO9zo17fZkHf4/frruNjlqX5qWgvzA8mbk1sNq7T89CMvpcW+O",
    "NK/j67Pv65nPyvG8U4lvnrwil/XXCVeypvv33/9Y3l5LP9dxbov16I93o61/eJ6xawT+/va85Cr",
    "PR9KoVRknNQd1e/Q52dVc47Z7l/i57/y/34uH/N3DpvOe+c5Za176zz+2fD180Br4Bf+4ntWPZc",
    "9aPx77yznX9u5Os/pj9x/IjxsOS0m3/Go+ug7Ot/IE+/ALc7s7E=",
    ""
  };
...
static void mdlSetWorkWidths_c8_sliding_controller2(SimStruct *S)
{
  const char* newstr = sf_c8_sliding_controller2_get_post_codegen_info();
  sf_set_work_widths(S, newstr);
  ssSetChecksum0(S,(1798722149U));
  ssSetChecksum1(S,(1715685181U));
  ssSetChecksum2(S,(4087187008U));
  ssSetChecksum3(S,(2229766121U));
}

static void mdlRTW_c8_sliding_controller2(SimStruct *S)
{
...
static void mdlSetupRuntimeResources_c8_sliding_controller2(SimStruct *S)
{
  SFc8_sliding_controller2InstanceStruct *chartInstance;
  chartInstance = (SFc8_sliding_controller2InstanceStruct *)utMalloc(sizeof
    (SFc8_sliding_controller2InstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc8_sliding_controller2InstanceStruct));
  chartInstance = new (chartInstance) SFc8_sliding_controller2InstanceStruct;
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_sliding_controller2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_sliding_controller2;
  chartInstance->chartInfo.mdlStart = sf_opaque_mdl_start_c8_sliding_controller2;
  chartInstance->chartInfo.mdlTerminate =
    sf_opaque_mdl_terminate_c8_sliding_controller2;
  chartInstance->chartInfo.mdlCleanupRuntimeResources =
    sf_opaque_cleanup_runtime_resources_c8_sliding_controller2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_sliding_controller2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_sliding_controller2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_sliding_controller2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_sliding_controller2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_sliding_controller2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_sliding_controller2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_sliding_controller2;
  ...
  mdl_setup_runtime_resources_c8_sliding_controller2(chartInstance);
}

void c8_sliding_controller2_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_SETUP_RUNTIME_RESOURCES:
    mdlSetupRuntimeResources_c8_sliding_controller2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_sliding_controller2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_sliding_controller2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_sliding_controller2_method_dispatcher.\n"
