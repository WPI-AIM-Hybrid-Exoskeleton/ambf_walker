...
struct B_sliding_controller2_T {
  ...
  real_T qd_add_n[7];                  /* '<S17>/addmittance gain' */
  real_T exosateration[7];             /* '<S4>/exo sateration' */
  real_T humansateration[7];           /* '<S4>/human sateration' */
 ...
 * '<S17>'  : 'sliding_controller2/Controller/addmittance'
 ...
 * '<S40>'  : 'sliding_controller2/Controller/addmittance/MATLAB Function'
