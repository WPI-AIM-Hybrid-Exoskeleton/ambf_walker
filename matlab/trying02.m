...
Km1= [6120.116528948097 0 0 0 0 0;
    ...
    0 0 0 6120.1165289481 0 0;0 0 0 0 2947.477314389203 0;0 0 0 0 0 101.7013888888889]
...
Kn0_ankle = 508.8125 % 508.8125; % params.all_cost_parameters(3,1).Value(2);
...
Bn0_ankle = 508.8125; % 508.8125; %params.all_cost_parameters(1,1).Value(2);
