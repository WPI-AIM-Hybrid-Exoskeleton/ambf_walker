...
rho_hip =  152; %params.all_cost_parameters(8,1).Value(1,1);
rho_knee = 450; % params.all_cost_parameters(8,1).Value(2,2);
rho_ankle = 50; %params.all_cost_parameters(8,1).Value(2,2);
...
lambda_hip = 0.11277; %params.all_cost_parameters(9,1).Value(1,1);
lambda_knee = 0.12389; %params.all_cost_parameters(9,1).Value(2,2);
lambda_ankle = 0.12; %params.all_cost_parameters(9,1).Value(2,2);
...
Kp0_hip =  15.0;
Kp0_knee = 0.7500; % params.all_cost_parameters(6,1).Value(2);
Kp0_ankle =  20.5; % params.all_cost_parameters(6,1).Value(2);

Kn0_hip =  15.0; % params.all_cost_parameters(3,1).Value(1);
Kn0_knee =  0.7508; % params.all_cost_parameters(3,1).Value(2);
Kn0_ankle = 20.508 % 508.8125; % params.all_cost_parameters(3,1).Value(2);

Bp0_hip =  15.0; % 0.9*params.all_cost_parameters(2,1).Value(1);
Bp0_knee = 0.7508; %$ params.all_cost_parameters(2,1).Value(2);
Bp0_ankle = 20.508; % params.all_cost_parameters(2,1).Value(2);

Bn0_hip =  15.0; %params.all_cost_parameters(1,1).Value(1);
Bn0_knee = 0.7508; % params.all_cost_parameters(1,1).Value(2);
