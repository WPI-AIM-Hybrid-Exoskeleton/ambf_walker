...
rho_hip = 152.6437; %params.all_cost_parameters(8,1).Value(1,1);
rho_knee = 457.9312; % params.all_cost_parameters(8,1).Value(2,2);
...
lambda_ankle = 1.0%params.all_cost_parameters(9,1).Value(2,2);
